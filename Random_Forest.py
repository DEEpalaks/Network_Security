...
rf_clf = RandomForestClassifier(n_estimators=50, max_features=0.7, max_depth=None, random_state=42)
rf_clf = RandomForestClassifier(n_estimators=50, max_features=1, max_depth=None, random_state=42)
clf_DoS=RandomForestClassifier(n_estimators=50, max_features=1, max_depth=None, random_state=42)
clf_Probe=RandomForestClassifier(n_estimators=50, max_features=1, max_depth=None, random_state=42)
clf_R2L=RandomForestClassifier(n_estimators=50, max_features=1, max_depth=None, random_state=42)
clf_U2R=RandomForestClassifier(n_estimators=50, max_features=1, max_depth=None, random_state=42)
...
plt.show()
pllot_confusion_matrix(clf_R2L, X_R2L_test, Y_R2L_test, cmap=plt.cm.Blues)
