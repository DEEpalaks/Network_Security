...
sorted(df.protocol_type.unique())
...
clf_Probe=DecisionTreeClassifier(min_samples_leaf=2,random_state=0)
clf_R2L=DecisionTreeClassifier(min_samples_leaf=2,random_state=0)
clf_U2R=DecisionTreeClassifier(min_samples_leaf=2,random_state=0)
